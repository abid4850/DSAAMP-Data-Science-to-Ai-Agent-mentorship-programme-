...
# After downloading data, flatten columns if MultiIndex
...
if 'Date' in data.columns:
    fig = px.line(data, x='Date', y=numeric_cols, title='Stock Price Time Series', width=1000, height=600)
else:
    fig = px.line(data, y=numeric_cols, title='Stock Price Time Series', width=1000, height=600)
st.plotly_chart(fig)
