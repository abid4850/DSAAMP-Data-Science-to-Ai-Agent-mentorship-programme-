#!/usr/bin/env python3
# To run on Linux: chmod +x 01_desktop_app.py && ./01_desktop_app.py
...
class OpenAIDesktopApp:
    def __init__(self, root):
        self.root = root
        # Remove emoji for Linux compatibility
    ...
    def setup_ui(self):
        ...
        title_label = ttk.Label(main_frame, text="OpenAI Desktop App", font=('Liberation Sans', 16, 'bold'))
        ...
        # Load API key from environment if available (Linux: check .bashrc/.zshrc or export)
